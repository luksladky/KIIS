...
class Container_3978bf323a extends Nette\DI\Container
{
	protected $meta = array(
		'types' => array(
			'Nette\Object' => array(
				array(
					...
					'facebook.client',
					'authorizator',
					'32_App_Model_PermissionRepository',
					'33_App_Model_ProfileRepository',
					'authenticator',
					'application.1',
					'application.2',
					'application.3',
			...
			'App\Model\EventFacade' => array(1 => array('31_App_Model_EventFacade')),
			...
			'App\Model\PermissionRepository' => array(
				1 => array('32_App_Model_PermissionRepository'),
			),
			'App\Model\ProfileRepository' => array(
				1 => array('33_App_Model_ProfileRepository'),
			),
			'App\Model\ThreadFacade' => array(1 => array('34_App_Model_ThreadFacade')),
		...
		'services' => array(
			'31_App_Model_EventFacade' => 'App\Model\EventFacade',
			'32_App_Model_PermissionRepository' => 'App\Model\PermissionRepository',
			'33_App_Model_ProfileRepository' => 'App\Model\ProfileRepository',
			'34_App_Model_ThreadFacade' => 'App\Model\ThreadFacade',
	 ...
	 */
	public function createService__31_App_Model_EventFacade()
	{
	 ...
	 */
	public function createService__32_App_Model_PermissionRepository()
	{
	 ...
	 */
	public function createService__33_App_Model_ProfileRepository()
	{
	 ...
	 */
	public function createService__34_App_Model_ThreadFacade()
	{
	...
	public function createServiceApplication__1()
	{
		...
		$service->threadFacade = $this->getService('34_App_Model_ThreadFacade');
		$service->profileRepository = $this->getService('33_App_Model_ProfileRepository');
		$service->eventFacade = $this->getService('31_App_Model_EventFacade');
	...
	public function createServiceApplication__7()
	{
		...
		$service->imageStorage = $this->getService('images.storage');
		$service->threadFacade = $this->getService('34_App_Model_ThreadFacade');
		$service->permissionRepository = $this->getService('32_App_Model_PermissionRepository');
	...
	{
		$service = new App\Model\UserManager($this->getService('database.default.context'), $this->getService('33_App_Model_ProfileRepository'));
		return $service;
	}
	...
	{
		return new Container_3978bf323a_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
final class Container_3978bf323a_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_3978bf323a $container)
	{
